    .global main
    .section .note.GNU-stack,"",@progbits # tira o warning
...
# ============================================================
# Procedimento: ler_operando
# Exibe mensagem e lê um double do usuário
# Parametros: rdi = string de prompt, retorna double em xmm0
# ============================================================
ler_operando:
    pushq %rbp
    movq %rsp, %rbp
    ...
    # scanf("%lf", &op)
    # vamos ler para um local na stack
    leaq -8(%rbp), %rsi
...
# Calcula fatorial de inteiro em rdi
